...
## Personalización
- **Hora de envío**: edita el `cron` en `.github/workflows/daily.yml` (diario) o `weekly-gaming.yml` (semanal). Está en UTC (10:43 UTC ≈ 07:43 Chile verano). GitHub ejecuta los crons con retraso, y a la hora en punto el atraso puede ser de horas: usa un minuto fuera de `:00` y espera que llegue unos minutos después de lo programado.
